...
var NetONEX = SXActiveX.extend({
	...
	getCertificateX: function() {
		return this.getInstanceX('CertificateX');
	},

	getPCSClientX: function() {
		return this.getInstanceX('PCSClientX');
	},

	getSVSClientX: function() {
		return this.getInstanceX('SVSClientX');
	},
	...
	getInstanceX: function(id) {
		...
		else if (id == 'CertificateX') {
			r = m.CreateCertificateXInstance();
		}
		else if (id == 'PCSClientX') {
			r = m.CreatePCSClientXInstance();
		}
		else if (id == 'SVSClientX') {
			r = m.CreateSVSClientXInstance();
		}
