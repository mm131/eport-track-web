  ...
  export default {
    ...
    data() {
      return {
        ...
        url: {
          delete: '/sys/depart/delete',
          edit: '/sys/depart/edit',
          deleteBatch: '/sys/depart/deleteBatch',
          exportXlsUrl: "sys/depart/exportXls",
          importExcelUrl: "sys/depart/importExcel",
        },
    ...
    methods: {
      ...
      loadTree() {
        ...
        that.treeData = []
        that.departTree = []
        queryDepartTreeList({hierarchy: true}).then((res) => {
          if (res.success) {
