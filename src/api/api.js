...
//货运追踪
const getGroupDetails = (params)=>getAction("/track/group/details",params);

//提单管理
const getBillDetails=(params)=>getAction("/bill/task/details",params);

//驳船管理
const getBargeDetails=(params)=>getAction("/BargeManage/task/details",params);
...
const queryall = (params)=>getAction("/sys/role/all",params);

//用户管理
const addUser = (params)=>postAction("/sys/user/add",params);
const editUser = (params)=>putAction("/sys/user/edit",params);
const queryUserRole = (params)=>getAction("/sys/user/role",params);
...
const queryTreeListForRole = (params)=>getAction("/sys/role/treeList",params);
const queryListAsync = (params)=>getAction("/sys/permission/queryListAsync",params);
const queryRolePermission = (params)=>getAction("/sys/permission/queryRolePermission",params);
const saveRolePermission = (params)=>postAction("/sys/permission/saveRolePermission",params);
const queryPermissionsByUser = (params)=>getAction("/sys/permission/listUserPermissions",params);
const loadAllRoleIds = (params)=>getAction("/sys/permission/loadAllRoleIds",params);
const getPermissionRuleList = (params)=>getAction("/sys/permission/getPermRuleListByPermId",params);
const queryPermissionRule = (params)=>getAction("/sys/permission/queryPermissionRule",params);

// 部门管理
const queryDepartTreeList = (params)=>getAction("/sys/depart/treeList",params);
const queryIdTree = (params)=>getAction("/sys/depart/idTree",params);
...
const getDashboardInfo = (params)=>getAction("/sys/dashboard",params);
